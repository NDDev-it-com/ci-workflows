...
| `.agents/skills/` | Authored skills. `.claude/skills/` is a generated byte mirror — run `scripts/sync_skills.py`, never hand-edit. |
| `.gds/**` | Generated estate projection. **Repository data, not an instruction surface**, and currently contradicts live state — see `docs/08`. |
